...
export const QueryGetRoadOperatorRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetRoadOperatorRequest>, I>>(
    object: I
  ): QueryGetRoadOperatorRequest {
    const message = createBaseQueryGetRoadOperatorRequest();
...
export const QueryGetRoadOperatorResponse = {
  ...
  fromJSON(object: any): QueryGetRoadOperatorResponse {
    return {
      roadOperator: isSet(object.roadOperator)
        ? RoadOperator.fromJSON(object.roadOperator)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetRoadOperatorResponse>, I>>(
    object: I
  ): QueryGetRoadOperatorResponse {
    const message = createBaseQueryGetRoadOperatorResponse();
    message.roadOperator =
      object.roadOperator !== undefined && object.roadOperator !== null
...
export const QueryAllRoadOperatorRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllRoadOperatorRequest>, I>>(
    object: I
  ): QueryAllRoadOperatorRequest {
    const message = createBaseQueryAllRoadOperatorRequest();
    message.pagination =
...
export const QueryAllRoadOperatorResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllRoadOperatorResponse>, I>>(
    object: I
  ): QueryAllRoadOperatorResponse {
    const message = createBaseQueryAllRoadOperatorResponse();
    message.roadOperator =
      object.roadOperator?.map((e) => RoadOperator.fromPartial(e)) || [];
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
...
export const QueryGetUserVaultRequest = {
  ...
  fromJSON(object: any): QueryGetUserVaultRequest {
    return {
      ...
      roadOperatorIndex: isSet(object.roadOperatorIndex)
        ? String(object.roadOperatorIndex)
        : "",
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetUserVaultRequest>, I>>(
    object: I
  ): QueryGetUserVaultRequest {
    const message = createBaseQueryGetUserVaultRequest();
...
export const QueryGetUserVaultResponse = {
  ...
  fromJSON(object: any): QueryGetUserVaultResponse {
    return {
      userVault: isSet(object.userVault)
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetUserVaultResponse>, I>>(
    object: I
  ): QueryGetUserVaultResponse {
    const message = createBaseQueryGetUserVaultResponse();
    message.userVault =
...
export const QueryAllUserVaultRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllUserVaultRequest>, I>>(
    object: I
  ): QueryAllUserVaultRequest {
    const message = createBaseQueryAllUserVaultRequest();
    message.pagination =
...
export const QueryAllUserVaultResponse = {
  ...
  fromJSON(object: any): QueryAllUserVaultResponse {
    return {
      userVault: Array.isArray(object?.userVault)
        ? object.userVault.map((e: any) => UserVault.fromJSON(e))
        : [],
      pagination: isSet(object.pagination)
        ? PageResponse.fromJSON(object.pagination)
        : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllUserVaultResponse>, I>>(
    object: I
  ): QueryAllUserVaultResponse {
    const message = createBaseQueryAllUserVaultResponse();
    message.userVault =
      object.userVault?.map((e) => UserVault.fromPartial(e)) || [];
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
        ? PageResponse.fromPartial(object.pagination)
        : undefined;
...
export class QueryClientImpl implements Query {
  ...
  RoadOperator(
    ...
    return promise.then((data) =>
      QueryGetRoadOperatorResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  RoadOperatorAll(
    ...
    return promise.then((data) =>
      QueryAllRoadOperatorResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  UserVault(
    ...
    return promise.then((data) =>
      QueryGetUserVaultResponse.decode(new _m0.Reader(data))
    );
  }
